...
<html>
 ...
 var nameL=4
 var regex = /^[a-zA-Z\s]+$/;                
 if(regex.test(name) === false || name.length<nameL) {
 printError("nameErr", "Please enter a valid name and not less than 4 characters");
 } else {
 printError("nameErr", "");
 nameErr = false;
 }
 ...
 // Validate Title
 if(title == "") {
 printError("titleErr", "Please enter your Message Title");
 } else {
 var titL=4
 var regex = /^[a-zA-Z\s]+$/;                
 if(regex.test(title) === false || title.length<titL) {
 printError("titleErr", "Please enter a valid Title and not less than 4 Characters");
 } else {
 printError("titleErr", "");
 titleErr = false;
 }
 ...
 var msgL=20
 var regex = /^[a-zA-Z\s]+$/;          
 if(regex.test(message) === false || message.length<msgL) {
 printError("messageErr", "Please enter a valid Message and not Less than 20 Character");
 } else {
...
<title>Oyemade Olufemi HTML Resume</title>
...
with quick turnaround time.</p>
   ...
   <div class="left">
     ...
     <div class="right">
     <br>
            <h3><i class="large material-icons">person</i>&nbsp;PERSONAL DATA</h3>
            <hr width="100%" size="#" color="tomato">
            <table>
                <tr id="heading">
                    <td>NATIONALITY:</td>
     ...
     <div class="right">
     <br>
            <h3><i class="large material-icons">work</i>&nbsp;WORKING EXPERIENCE</h3>
            <hr width="100%" size="#" color="tomato">
      
       <p id="company-name">Biswal Limited    &nbsp;(March 2016 - July 2019) </p>
            <p id="job-title"><strong>Regional Operations and Maintenance Coordinator (Passive)</strong></p>
...
<li>Tracking Site Tower Maintenance team and sharing tower Audit report with customer</li>
 ...
 <p id="company-name">Virgo Services Nigeria Limited.	&nbsp;(December 2015 - March 2016)</p>
            <p id="job-title"><strong>PPM Coordinator and Quality Control Specialist(Diesel Analyst)
</strong></p>
...
<p id="company-name">Virgo Services Nigeria Limited.	&nbsp;(October 2014 2015 - December 2015)</p>
  <p id="job-title"><strong>IT Specialist/Data Analyst
            </strong></p>
...
<p id="company-name">Dankani Guest Palace Hotels Ltd.	&nbsp;(July 2012 - September 2014)</p>
  <p id="job-title"><strong>IT Support Manager </strong></p>
...
(CCTV cameras), Door Lock Solutions, Intercom and Satellite Stations.</li>
 ...
 <p id="company-name">Huawei Technologies Ltd.	&nbsp;(February 2009 - July 2012)</p>
    <p id="job-title"><strong>BSS/RF Engineer </strong></p>
    
    <p id="job-responsibilities"><u>Job Responsbilities</u></p>
    <p>
    <ul>
    <li>Rollout of BTS Stations, Swap of Sites, Microwaves, Expansion project for 2G and 3G</li>
    <li>Main activities and responsibilities:</li>
    <li>Check Materials at Site</li>
    <li>Coordinating and Quality Inspection of Installation at Site</li>
    <li>Commissioning of Microwave links both PDH/SDH</li>
    <li>Integration of sites.</li>
    <li>Microwave Dish Installation.</li>
    <li>3G (Node B) Installation and Commissioning.</li>
    ...
    <li>Service Configuration, Cross-Connection & BTS/MW E1 Cable Colour Code</li>
    <li>Physical punching of E1 BTS cable & MW Tributary Cable at DDF</li>
    <li>Alignment, Troubleshooting and link restoration if Site Down</li>
    <li>Use of Work Other (WO) & Design Link Budget (LB) </li>
    <li>Familiar with BTS3012 (Indoor), BTS3900 both (Indoor) and (Outdoor)</li>
    <hr  size="#"></u1></p>
    </li>
    </ul>
    </p>
...
<p id="company-name">Femsoft Cyber Solutions.	&nbsp;(October 2008 - January 2009)</p>
  <p id="job-title"><strong>IT Support Analyst </strong></p>
  
    <p id="job-responsibilities"><u>Job Responsbilities</u></p>
       <p>
   <ul>
    <li>Installation and Monitoring Broadband networks(Wired & Wireless,  Router, Hotspot);</li>
    <li>Supporting Client for Internet Troubleshooting;</li>
    <li>Designing of Management System Software for Schools, Hospitals and ERP software for small and medium business;</li>
    <li>Design Website and Web Applications for their Clients.</li>
          </u1></p>   
    
     </div>
<br>
          <h3><i class="large material-icons">school</i>&nbsp;EDUCATIONAL QUALIFICATIONS</h3>
          <hr width="100%" size="#" color="tomato">
            <table>
                <tr id="heading">
                    <td><h4><u>Qualification</u></h4></td>
                    <td><h4><u>Institution</u></h4></td>
                    <td><h4><u>Year</u></h4></td>
                </tr>
                <tr>
                    <td>&nbsp;M.Sc Information Technology</td>
                    <td>&nbsp;National Open University, Abuja FCT, Nigeria</td>
                    <td>&nbsp;2016</td>
                </tr>
                <tr>
                    <td>&nbsp;B.Sc Computer Science</td>
                    <td>&nbsp;Usmanu Danfodiyo University, Sokoto, Sokoto State</td>
                    <td>&nbsp;2011</td>
                </tr>
                <tr>
                    <td>&nbsp;OND Computer Science</td>
                    <td>&nbsp;Abdu Gusau Polytechnic,Galata Mafara, Zamfara State</td>
                    <td>&nbsp;2007</td>
                </tr>
                <tr>
                    <td>&nbsp;Secondary School Certificate Examination</td>
                    <td>&nbsp;Urban Day Grammar School, Ile-Ife, Osun State</td>
                    <td>&nbsp;2004</td>
                </tr>
                <tr>
                    <td>&nbsp;Primary School Leaving Certificate</td>
                    <td>&nbsp;All Saint Pry School, Wannisani, Ile-Ife, Osun State</td>
                    <td>&nbsp;2006</td>
                </tr>
              
            </table>
            <br>
            <h3><i class="large material-icons">school</i>&nbsp;TRAINING COURSES ATTENDED</h3>
            <hr width="100%" size="#" color="tomato">
            <p>
            <ul>
            <li>Advance Diploma in Computer Information Technology</li>
            <li>Diploma in Computer Engineering</li>
            <li>Certificate in Computer Appreciation </li>
            <li>Cloud Computing, University of Illinois at Urbana  Champaign</li>
            <li>Control of Mobile Robots, Georgia Institute of Technology</li>
            <li>Human Computer Interaction, University of California, San Diego</li>
            <li>Web Intelligence and Big Data, Indian Institute of Technology</li>
            <li>Malicious Software and its underground Economy, University of London</li>
            </ul>
            <br>
            <h3><i class="large material-icons">library_books</i>&nbsp;PERSONAL SKILLS</h3>
            <hr width="100%" size="#" color="tomato">
            <p>
            <ul>
                <li>Knowledgeable in Information Computer Technology (ICT)</li>
                ...
                <li>Excellent at Providing outstanding friendly customer service and help</li>
                <li>Enthusiastic team player experienced in motivating others to accomplish a goal</li>
                <li>Strong listening, writing and communication skills</li>
                <li>Ability to handle confidential or sensitive information effectively </li>
                <li>Proactive problem solver who is good at thinking "out of the box"</li>
                <li>Understanding of AC and DC power system </li>
                <li>Has hand on experience in handling site passive equipment</li>
                <li>Demonstrated skills of co-ordination with multiple vendors and sake holders</li>
                <li>Understanding of Telecommunications Business</li>
                <li>Demonstrate good knowledge of GSM related Power Network</li>
                <li>Demonstrate good knowledge of operations & maintenance of power system</li>
                
                </ul>
           </p>
           <br>
            <h3><i class="large material-icons">gesture</i>&nbsp;INTERESTS & ACTIVITIES</h3>
            <hr width="100%" size="#" color="tomato">
            <p>
            <ul>
                <li>Computer programming</li> <li>Reading </li><li>Writing</li><li>Counseling</li><li>Traveling</li></ul>
            
            </p>
            <br>
            <h3><i class="large material-icons">language</i>&nbsp;LANGUAGE PROFICIENCY</h3>
            <hr width="100%" size="#" color="tomato">
            <p>
            <ul>
                <li>
                English - Fluently </li><li>Yoruba - Fluently</li> <li>Hausa - Basic
                </li> </ul>
            
            </p>
            <br>
            <h3><i class="large material-icons">redeem</i>&nbsp;PROFICIENCY</h3>
            <hr width="100%" size="#" color="tomato">
            <p>
            <ul>
                <li>
...
software
                ...
                <li>Use of Work Other (WO) & Design Link Budget (LB) </li>
                <li>Familiar with BTS3012 (Indoor), BTS3900 both (Indoor) and (Outdoor)</li>
                <li>Troubleshooting of DG, AC, INALA, DC components, AMF panel etc.</li></ul>
         
            </p>
            <br>
            <h3><i class="large material-icons">people</i>&nbsp;REFEREES</h3>
            <hr width="100%" size="#" color="tomato">
            <p>
            On Request</p>
            <br>
            ...
            <input type="text" name="name" minlenght="4"> 
            ...
            <div class="row">
            <label>Title</label>
            <input type="text" name="title" minlenght="4">
            <div class="error" id="titleErr"></div>
            </div>
            <div class="row">
            <label >Your message:</label>
            <textarea id="message" name="message" rows="7" cols="40" minlenght="20"></textarea>
